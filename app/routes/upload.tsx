...
export default function Upload() {
    ...
    const handleAnalyze = async ({companyName, jobTitle, jobDescription, file} : {companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
        ...
        setStatusText("Updating the image...");
        ...
        if(!feedback) return setStatusText('Failed to analyze');
      ...
      <section className="main-section">
        <div className="page-heading py-16">
            ...
            {isProcessing ? (
                ...
                <h2>Drop yuor resume for an ATS score and improvement</h2>
            )}
            ...
            {!isProcessing && (
                <form id="upload-form" onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8">
                    ...
                    <div className="form-div">
                        ...
                        <textarea  rows={5} placeholder="Write a clear & concise job description with responsibilities & expectations..." name="job-description" />
                    </div>
